...
const flagshipProjects = [
  {
    id: 1,
    title: "Taksim 360 Kentsel Yenileme & Restorasyon",
    category: "Restorasyon & Koruma",
  ...
  {
    id: 2,
    title: "Tarihi Yapı Geoteknik Zemin & Mini Kazık Güçlendirme",
    category: "Statik Güçlendirme",
  ...
  {
    id: 4,
    title: "Tarihi Avlu Doğal Taş Döşeme & Düzenleme",
    category: "Taahhüt & Taş Ustalığı",
  ...
  {
    id: 5,
    title: "Tescilli Cephe Askılama & Çelik Tahkimat",
    category: "Statik Güçlendirme",
  ...
  {
    id: 6,
    title: "Geleneksel Masif Ahşap Pencere Rekonstrüksiyonu",
    category: "Rölöve & Ahşap Zanaat",
      ...
      <div className="container" style={{ position: "relative", zIndex: 2 }}>
        <div className={styles.header}>
          <div className={styles.headerLeft}>
            <span className={styles.tagline}>Seçkin Portföy</span>
            <h2 className={styles.title}>Öne Çıkan Projeler</h2>
            <p className={styles.subtitle}>
              Her biri tarihe, çevreye ve insana saygı ilkesiyle hayata geçirilen ustalık eserlerimiz.
            </p>
          </div>
